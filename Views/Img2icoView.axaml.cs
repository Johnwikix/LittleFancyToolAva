...
public partial class Img2icoView : UserControl
{
    ...
    private async void OnDrop(object? sender, DragEventArgs e)
    {
        ...
        if (DataContext is not Img2icoViewModel vm) return;
        if (vm.IsBusy) return;
    ...
    {
        if (DataContext is Img2icoViewModel vm && vm.IsBusy) return false;
